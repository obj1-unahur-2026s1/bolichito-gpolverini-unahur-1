# Documentación del Proyecto Bolichito

Bienvenido a la documentación del proyecto "Gustos y Bolichito". Esta guía te ayudará a navegar por toda la documentación disponible.
...
bolichito/
├── src/                    # Código fuente
│   ├── bolichito.wlk      # Lógica del bolichito
│   ├── colores.wlk        # Definición de colores
│   ├── materiales.wlk     # Definición de materiales
│   ├── objetos.wlk        # Objetos del bolichito
│   └── personas.wlk       # Personas con sus gustos
├── tests/                  # Tests unitarios
│   ├── bolichito.wtest    # Tests del bolichito
│   ├── colores.wtest      # Tests de colores
│   ├── materiales.wtest   # Tests de materiales
│   ├── objetos.wtest      # Tests de objetos
│   └── personas.wtest     # Tests de personas
...
5. **Empezar a desarrollar** → Ver [development.md](development.md)
